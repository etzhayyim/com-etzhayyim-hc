...
(defn collection
  [name]
  (str "com.etzhayyim.hc." name))

(def cell-specs {
  :listhc {:legacy-cell "com-etzhayyim-apps-hc-listHc"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "listhc")]
     :required-gates common-gates
     :trigger "manifest cell listhc"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :searchhc {:legacy-cell "com-etzhayyim-apps-hc-searchHc"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "searchhc")]
     :required-gates common-gates
     :trigger "manifest cell searchhc"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :createhc {:legacy-cell "com-etzhayyim-apps-hc-createHc"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "createhc")]
     :required-gates common-gates
     :trigger "manifest cell createhc"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :createspapplication {:legacy-cell "com-etzhayyim-apps-hc-createSpApplication"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "createspapplication")]
     :required-gates common-gates
     :trigger "manifest cell createspapplication"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :summarizehc {:legacy-cell "com-etzhayyim-apps-hc-summarizeHc"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "summarizehc")]
     :required-gates common-gates
     :trigger "manifest cell summarizehc"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :get {:legacy-cell "com-etzhayyim-apps-hc-coverage-get"
     :phase :event
     :murakumo-node "reuben"
  ...
  :task {:legacy-cell "com-etzhayyim-apps-hc-task"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :spapplication {:legacy-cell "com-etzhayyim-apps-hc-spApplication"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "spapplication")]
     :required-gates common-gates
     :trigger "manifest cell spapplication"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :spverification {:legacy-cell "com-etzhayyim-apps-hc-spVerification"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "spverification")]
     :required-gates common-gates
     :trigger "manifest cell spverification"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :spaudit {:legacy-cell "com-etzhayyim-apps-hc-spAudit"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "spaudit")]
     :required-gates common-gates
     :trigger "manifest cell spaudit"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
